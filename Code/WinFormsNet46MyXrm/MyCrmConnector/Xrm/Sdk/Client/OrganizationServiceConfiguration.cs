...
namespace MyCrmConnector.Client
{
    ...
    IEndpointSwitch
  {
    ...
    public bool IsPrimaryEndpoint => this.service.IsPrimaryEndpoint;
        ...
        Microsoft.Xrm.Sdk.Client.PolicyConfiguration IServiceConfiguration<IOrganizationService>.PolicyConfiguration => throw new NotImplementedException();

        Microsoft.Xrm.Sdk.Client.PolicyConfiguration IServiceManagement<IOrganizationService>.PolicyConfiguration => throw new NotImplementedException();
        ...
        Microsoft.Xrm.Sdk.Client.IdentityProvider IServiceConfiguration<IOrganizationService>.GetIdentityProvider(string userPrincipalName)
        {
            throw new NotImplementedException();
        }
