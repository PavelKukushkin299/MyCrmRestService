...
namespace Microsoft.Xrm.Sdk.Messages
{
  ...
  public sealed class UpdateStateValueRequest : OrganizationRequest
  {
    ...
    {
      get => this.Parameters.Contains(nameof (DefaultStatusCode)) ? (int?) this.Parameters[nameof (DefaultStatusCode)] : new int?();
      set => this.Parameters[nameof (DefaultStatusCode)] = (object) value;
    }
