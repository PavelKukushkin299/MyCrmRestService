...
namespace Microsoft.Xrm.Sdk.Client
{
  internal abstract class ServiceContextInitializer<TService> : IDisposable where TService : class
  {
    ...
    protected void Initialize(Microsoft.Xrm.Sdk.Client.ServiceProxy<TService> proxy) => this._operationScope = new OperationContextScope((IContextChannel) (object) proxy.ServiceChannel.Channel);
