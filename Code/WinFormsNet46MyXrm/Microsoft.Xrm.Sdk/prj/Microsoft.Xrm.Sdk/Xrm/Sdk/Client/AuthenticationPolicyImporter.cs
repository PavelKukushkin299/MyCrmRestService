  ...
  internal sealed class AuthenticationPolicyImporter : IPolicyImportExtension
  {
    ...
    private bool ImportPolicyLegacy(PolicyConversionContext context)
    {
      ...
      if (xmlElement == null)
        return false;
      bool flag = true;
      Microsoft.Xrm.Sdk.Client.AuthenticationPolicy xrmPolicyBindingElement = context.BindingElements.Find<Microsoft.Xrm.Sdk.Client.AuthenticationPolicy>();
      if (xrmPolicyBindingElement == null)
      {
        xrmPolicyBindingElement = new Microsoft.Xrm.Sdk.Client.AuthenticationPolicy();
    ...
    private static void ExtractLiveTrustElements(
      Microsoft.Xrm.Sdk.Client.AuthenticationPolicy xrmPolicyBindingElement,
    ...
    {
      bool flag = true;
      Microsoft.Xrm.Sdk.Client.AuthenticationPolicy authenticationPolicy = context.BindingElements.Find<Microsoft.Xrm.Sdk.Client.AuthenticationPolicy>();
