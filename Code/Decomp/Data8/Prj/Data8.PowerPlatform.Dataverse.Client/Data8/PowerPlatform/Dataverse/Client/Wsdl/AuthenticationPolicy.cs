...
// Type: Data8.PowerPlatform.Dataverse.Client.Wsdl.AuthenticationPolicy
...
namespace Data8.PowerPlatform.Dataverse.Client.Wsdl
{
  ...
  {
    [XmlElement("Authentication", Namespace = "http://schemas.microsoft.com/xrm/2011/Contracts/Services")]
