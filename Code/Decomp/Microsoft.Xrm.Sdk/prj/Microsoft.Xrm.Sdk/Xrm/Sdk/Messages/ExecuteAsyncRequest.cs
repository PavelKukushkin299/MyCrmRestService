...
namespace Microsoft.Xrm.Sdk.Messages
{
  ...
  public sealed class ExecuteAsyncRequest : OrganizationRequest
  {
    ...
    {
      get => this.Parameters.Contains(nameof (Request)) ? (OrganizationRequest) this.Parameters[nameof (Request)] : (OrganizationRequest) null;
      set => this.Parameters[nameof (Request)] = (object) value;
    }
